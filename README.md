...
2022-12-25, 15시 완료 단, 에러사항 및 배운점 정리 필요
...
📌tests - apiTest폴더에 axios를 테스트 하는 코드를 작성 했는데 제대로 작성한건지
...
📌복잡한 로직이 없어서 useMemo, useCallback, React.memo등을 사용하면 오히려 성능이 저하 된다고 생각하는데 혹시 렌더링, 성능 개선할 부분이 있는지 확인받고 싶습니다.
