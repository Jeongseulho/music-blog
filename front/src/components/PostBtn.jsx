  ...
  return (
    <div className="inline-flex h-12 w-24 items-center rounded-md shadow-sm">
      ...
      <button
        ...
        className="inline-flex items-center space-x-1 border-y border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-800 hover:bg-slate-100 hover:text-blue-600"
      >
        <span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
